...
"gunsbet": {
 ...
 "extra": "<h3>Longevity counts for something</h3><p>Gunsbet has been operating since 2016. In a market where most brands on this page launched in 2023 or 2024, a nine-year track record is a genuine signal &mdash; operators that withhold payments do not usually last that long.</p><p>The welcome offer is the largest sportsbook-side package available to New Zealanders here, at 285% up to NZ$14,700 with 285 free spins.</p><h3>Two significant drawbacks for a Kiwi</h3><p>First, <strong>no cryptocurrency at all</strong>. In 2026 that is unusual, and it removes the fastest and most reliable withdrawal route available to New Zealanders &mdash; the one that is immune to New Zealand bank declines. Withdrawals are e-wallet or card only, at 12 to 24 hours and two to five business days respectively.</p><p>Second, it is <strong>euro-denominated</strong>. At roughly &euro;7,500 the headline is about NZ$14,700, but you pay a conversion spread of 2 to 3% depositing and again withdrawing. On NZ$2,000 of turnover that is around NZ$100 &mdash; larger than the margin difference between almost any two books.</p><p>Rugby coverage is also thinner than Rooster Bet&rsquo;s, which matters in a New Zealand context.</p>",
},
"betandplay": {
