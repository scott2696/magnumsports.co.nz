...
SEEDS = {
 ...
 "/high-payout-casinos/": ["highest payout online casino nz", "casino rtp", "best payout casino nz"],
 "/fast-payout-casinos/": ["fast payout casino nz", "casino withdrawal nz", "instant withdrawal casino nz"],
 "/live-casinos/": ["live casino nz", "live dealer casino nz"],
 "/best-crypto-casinos/": ["crypto casino nz", "bitcoin casino nz"],
 "/online-casinos/bonuses/": ["casino bonus nz", "wagering requirements", "welcome bonus casino nz"],
 "/no-deposit-casinos/": ["no deposit bonus nz", "free spins no deposit nz"],
 "/online-betting/": ["online betting nz", "betting sites nz", "sports betting nz", "tab nz betting"],
 "/nz-online-casino-law/": ["is online gambling legal in new zealand", "nz online gambling law",
 ...
 "/payment-methods/": ["casino payment methods nz", "poli casino", "casino deposit nz"],
