# -*- coding: utf-8 -*-
"""Homepage — primary target: best online casino sites NZ."""
from lib import *

TITLE = "Best Online Casino Sites NZ 2026 | Top 16 Tested for Kiwis"
DESC = ("We deposited our own NZD at 41 sites and timed every withdrawal. Compare the best online "
        "casino sites NZ players can use in 2026, ranked on payout speed, NZD banking, pokies range "
        "and bonus terms you can actually clear.")
PATH = "/"
...
FAQ = [
 ...
 ("Do I need an app, or does the browser work?",
...
<p>Confiscating balances on vague &ldquo;bonus abuse&rdquo; grounds, refusing withdrawals to verified accounts, running unlicensed, or advertising a bonus whose terms contradict the banner. We have excluded nine sites this year on those grounds, several of which pay considerably more commission than anything in our top five. <a href="/how-we-review/">Read the full methodology &rarr;</a></p></div>
</div></section>
''')

    # ---- what makes a good casino for a kiwi
