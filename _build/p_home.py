...
def build():
    ...
    schema = page_schema(
        ...
        extra=[store_schema(),
               crumb_schema([("Home", "/")]),
               faq_schema(FAQ + paa_items(PATH), f"{SITE}/#faq")])
...
<div class="card card--link"><div class="card-ic">{icon("ball")}</div><h3>Best Sports Betting Sites</h3><p>Every book that still takes Kiwi punters, ranked on rugby union and NRL market depth, the margin you pay on every bet, in-play reliability and how fast the money comes back.</p><p><a href="/online-betting/#sites">Compare bookmakers &rarr;</a></p></div>
